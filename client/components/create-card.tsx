...
const CreateCard: React.FC<EmailProps> = ({ email, setEmail }) => {
  ...
  const handleEdit = (sound: SoundType) => {
  ...
  const handleUpdate = (soundId: number) => {
