...
interface Window {
  YT: {
    Player: {
      new (element: string, options: any): any;
    };
  };
}
...
const Videos: React.FC<EmailProps> = ({ email, setEmail }) => {
  ...
  // test removing the event:any from the 2 functions below
    ...
    <div className="video-text">
      ...
      <div className="embed-video">
        ...
        {/* {showModal && (
          ...
          >
            <SpeechPractice email={email} setEmail={setEmail} />
          </Modal>
        )} */}
      </div>
    </div>
